w.props = {
    ...
    "selectedRegionColor": "#CC0066",
    "crosshair": true,
    "marginLeft": 0,
    "marginBottom": 0,
    "marginTop": 0,
    "marginRight": 0,
    "seriesBorderColor": "#000000",
            ...
            map: {
                ...
                events: {
                    click: function (event) { console.log(event)
                        if (!event.point.selected) { visApi().setFilterSelectedValues('07c1992b289f47de9b552c80fd70b696', [[event.point["hc-code"]]], function (response) {})}
                        else {visApi().setFilterSelectedValues('07c1992b289f47de9b552c80fd70b696', [], function (response) {})}
                    }
                },
                states: {
                    select: {
